...
var tsStreamTypeMap = scalar.UintRangeToScalar{
	...
	{Range: [2]uint64{0x01, 0x01}, S: scalar.Uint{Description: "ISO/IEC 11172-2 Video"}},
	{Range: [2]uint64{0x02, 0x02}, S: scalar.Uint{Description: "ISO/IEC 13818-2 or ISO/IEC 11172-2"}},
	{Range: [2]uint64{0x03, 0x03}, S: scalar.Uint{Description: "ISO/IEC 11172-3 Audio"}},
	{Range: [2]uint64{0x04, 0x04}, S: scalar.Uint{Description: "ISO/IEC 13818-3 Audio"}},
	...
	{Range: [2]uint64{0x0f, 0x0f}, S: scalar.Uint{Description: "ISO/IEC 13818-7 Audio with ADTS transport syntax"}},
	{Range: [2]uint64{0x10, 0x10}, S: scalar.Uint{Description: "ISO/IEC 14496-2 Visual"}},
	{Range: [2]uint64{0x11, 0x11}, S: scalar.Uint{Description: "ISO/IEC 14496-3 Audio with the LATM"}},
	...
	{Range: [2]uint64{0x1b, 0x1b}, S: scalar.Uint{Description: "AVC video stream as defined in ITU-T Rec. H.264 | ISO/IEC 14496-10 Video"}},
